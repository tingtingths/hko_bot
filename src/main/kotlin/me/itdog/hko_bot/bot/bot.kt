package me.itdog.hko_bot.bot

import com.google.common.cache.CacheBuilder
import com.google.common.cache.CacheLoader
import com.google.common.cache.LoadingCache
import me.itdog.hko_bot.Global
    ...
    inner class Localiser(private val botLocale: BotLocale) {
        ...
        init {
            localisations[BotLocale.ZH_HK] = mapOf(
                ...
                Pair(LocaliseComponent.UPDATED_AT, "%s 更新"),
                Pair(LocaliseComponent.HONG_KONG_OBSERVATORY, "香港天文台"),
            )
            localisations[BotLocale.EN_UK] = mapOf(
                ...
                Pair(LocaliseComponent.UPDATED_AT, "Updated at %s"),
                Pair(LocaliseComponent.HONG_KONG_OBSERVATORY, "Hong Kong Observatory"),
            )
        }
